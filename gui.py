...
if __name__ == '__main__':
    ...
    var8 = IntVar()
    Checkbutton(master, text="hm", variable=var8).grid(row=9, sticky=W)
    var9 = IntVar()
    ...
    var14 = IntVar()
    Checkbutton(master, text="macys", variable=var14).grid(row=15, sticky=W)
    var15 = IntVar()
    ...
    var18 = IntVar()
    Checkbutton(master, text="sams club", variable=var18).grid(row=19, sticky=W)
    var19 = IntVar()
    ...
    var23 = IntVar()
    Checkbutton(master, text="Acessories", variable=var23).grid(row=2, column=2, sticky=W)
    var24 = IntVar()
    Checkbutton(master, text="Computers", variable=var24).grid(row=3, column=2, sticky=W)
    var25 = IntVar()
    Checkbutton(master, text="Dresses", variable=var25).grid(row=4, column=2, sticky=W)
    var26 = IntVar()
    Checkbutton(master, text="Eyes Makeup", variable=var26).grid(row=5, column=2, sticky=W)
    var27 = IntVar()
    Checkbutton(master, text="Headphones & Speakers", variable=var27).grid(row=6, column=2, sticky=W)
    var28 = IntVar()
    Checkbutton(master, text="Lips", variable=var28).grid(row=7, column=2, sticky=W)
    var29 = IntVar()
    ...
    var31 = IntVar()
    Checkbutton(master, text="Shoes", variable=var31).grid(row=10, column=2, sticky=W)
    var32 = IntVar()
    ...
    var34 = IntVar()
    Checkbutton(master, text="Tops", variable=var34).grid(row=13, column=2, sticky=W)
    var35 = IntVar()
